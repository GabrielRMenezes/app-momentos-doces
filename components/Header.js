...
export default function Header({
  ...
  const handleAddTransaction = () => {
    toggleModal()
    onAddTransaction() // Chama a função que deve exibir o formulário de transação
  }
...
// export default function Header({ name, gender }) {
//   const [isModalVisible, setModalVisible] = useState(false)
...
//         <View style={styles.modalContent}>
//           <Text style={styles.menuTitle}>Selecione uma opção</Text>
//           <Text style={styles.menuContent} onPress={TransactionForm}>
//             Criar Transação
//           </Text>
//           <Text style={styles.menuContent} onPress={TransactionForm}>
//             Alterar Transação
